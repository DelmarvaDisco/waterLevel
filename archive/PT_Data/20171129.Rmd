---
title: "November 29, 2017 Data Download & Processing"
output:
  html_document:
    df_print: paged
    toc: yes
...
working_dir<-"//nfs/palmer-group-data/Choptank/Nate/PT_Data/20171129_Downloads/"
...
fun<-function(n){
  ...
  df_historic<-NULL#db_get_water_level_ts(db,paste(master$Site_Name[i]))
