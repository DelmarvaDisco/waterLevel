---
title: "November 1, 2017 Data Download & Processing"
output:
  html_document:
    df_print: paged
    toc: yes
...
working_dir<-"//nfs/palmer-group-data/Choptank/Nate/PT_Data/20171101_Downloads/"
...
fun<-function(n){
  ...
  df_historic<-db_get_water_level_ts(db,paste(master$Site_Name[1]))
...
#Edits
#df<-df[!(df$Timestamp>as.POSIXct("2017-09-27 04:00 UTC") & df$Timestamp<as.POSIXct("2017-09-27 11:00 UTC")),]

#export updated csv
#write.csv(df, paste0(working_dir, "intermediate/",master$Sonde_ID[n],".csv"))
