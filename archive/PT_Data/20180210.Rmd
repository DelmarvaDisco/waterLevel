---
title: "Feb 10, 2018 Data Download & Processing"
output:
  html_document:
    df_print: paged
    toc: yes
...
working_dir<-"//nfs/palmer-group-data/Choptank/Nate/PT_Data/20180210_Downloads/"
...
fun<-function(n){
  ...
  relative_wl<-master$Relative_Water_Level_m[master$Sonde_ID==serial_number]
    if(is.na(relative_wl)==T){relative_wl<-0}
...
1. Something is funny with the second half of the baro logger [after 1/14]
2. Need to insert Quint outlet logger into equipment tables
```{r, echo=FALSE}
