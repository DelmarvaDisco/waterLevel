---
title: "December 20, 2017 Data Download & Processing"
output:
  html_document:
    df_print: paged
    toc: yes
...
working_dir<-"//nfs/palmer-group-data/Choptank/Nate/PT_Data/20171220_Downloads/"
...
fun<-function(n){
  ...
  #Water Level
  df$waterLevel<-df$gageHeight+as.numeric(paste(relative_wl))
