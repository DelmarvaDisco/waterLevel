...
#Adding sites not previously included in the database
#db_describe_site(db, site_code = "Tracer Catchment Outlet")
#db_describe_site(db, site_code = "SB Wetland Well Shallow")
...
#Water Level QAQC
```{r}
#Eventually, I would like to create a shyiny app + more optimization. Actually, since I"m wildly brainstorming...it would be BA to create a shiny app to (1) define the shift and (2) clip bad pieces of data.   
fun<-function(n){
