---
title: "October 20, 2017 Data Download & Processing"
output:
  html_document:
    df_print: paged
    toc: yes
...
#QAQC
df<-df[df$Timestamp>as.POSIXct("2017-09-27 08:00 UTC"),]
...
#QAQC
df<-df[df$Timestamp>as.POSIXct("2017-09-28 08:00 UTC"),]
...
#QAQC
df<-df[df$Timestamp>as.POSIXct("2017-09-27 06:30 UTC"),]
...
##DK Upland Well 2
This is preliminary data and will undergo more rigurous QAQC at a later date. 
  1. There is a shift in early augst that needs to be dealt with! :) 
...
#QAQC
df<-df[df$Timestamp>as.POSIXct("2017-08-17 10:30 UTC"),]
...
fun<-function(n){
  ...
  db_insert_results_ts(db = db, # database connecton
                       ...
                       method = "PT_Download",
                       site_code = as.character(master$Site_Name[n]),
                       variables = vars_list,
