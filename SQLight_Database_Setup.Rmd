...
#Connect to databse
#db<-dbConnect(RSQLite::SQLite(), paste0(working_dir,"odm2.sqlite"))
```
...
##2.3 Describe Method
Use the [db_describe_method](https://khondula.github.io/rodm2/reference/db_describe_method.html) function to describe pressure transducer deployment method. Note, we are using the "[dataRetrieval](http://vocabulary.odm2.org/methodtype/dataRetrieval/)" method from the controlled vocabulary. 
